        ...
        return (h("ion-row", null,
            ...
            h("ion-col", { "col-9": true },
                h("div", { class: "druid-dialogue-vitals" },
                    ...
                    h("ul", { class: "nav nav-stacked " },
                        h("li", null,
                            h("a", null,
                                h("span", { class: "card-list-key " }, "Heartrate"),
                                "   ",
                                h("span", { class: "card-list-value " }, " \u00A0 48"))),
                        h("li", null,
                            h("a", null,
                                h("span", { class: "card-list-key " }, "SpO2 "),
                                "       ",
                                h("span", { class: "card-list-value " }, " \u00A0 91"))),
                        h("li", null,
                            h("a", null,
                                h("span", { class: "card-list-key " }, "Temprature "),
                                " ",
                                h("span", { class: "card-list-value " }, " \u00A038 "))),
                        h("li", null,
                            h("a", null,
                                h("span", { class: "card-list-key " }, "NIBP"),
                                "        ",
                                h("span", { class: "card-list-value " }, " \u00A0 89 "))),
                        h("li", null,
                            h("a", null,
                                h("span", { class: "card-list-key " }, "RR"),
                                "          ",
                                h("span", { class: "card-list-value " }, " \u00A0 121 "))))))));
    }
